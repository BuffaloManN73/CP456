...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 21, 2019 at 02:03 PM
...
INSERT INTO `user` (`id`, `username`, `password`, `email`, `phone`, `game1`, `game2`, `game3`) VALUES
(1, 'admin', '123', 'admin', '0123456789', 0, 0, 0),
(5, '', '', '', '', NULL, NULL, NULL),
(6, 'asfsa', 'fsafsaf', 'safsaf', 'safsa', NULL, NULL, NULL),
(7, 'asf', '', '', '', NULL, NULL, NULL),
(8, 'ad', 'fas', 'asfqqqq', 'qqqq', NULL, NULL, NULL);
